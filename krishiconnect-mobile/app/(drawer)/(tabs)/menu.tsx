...
const MENU_ITEMS: { route: string; label: string; icon: keyof typeof Ionicons.glyphMap }[] = [
  { route: '/(drawer)/(tabs)/saved', label: 'Saved', icon: 'bookmark-outline' },
  { route: '/(drawer)/(tabs)/alerts', label: 'Alerts', icon: 'notifications-outline' },
  { route: '/(drawer)/(tabs)/messages', label: 'Messages', icon: 'chatbubbles-outline' },
  ...
  { route: '/(drawer)/(tabs)/settings', label: 'Settings', icon: 'settings-outline' },
];
